...
//Your function here...
function sortWithRecursion(array, sortedArray = []){
  //base case
  if (array.length === 0){return sortedArray;}
  let min = findMinValue(array);
  sortedArray.push(min)
  array.splice(array.indexOf(min),1);
  return sortWithRecursion(array, sortedArray)
}
...
console.log("Recusive Sort");
console.log(sortWithRecursion(nums1));
console.log(sortWithRecursion(nums2));
console.log(sortWithRecursion(nums3));
